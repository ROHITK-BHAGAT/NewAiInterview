    ...
    <div className="flex w-full">
      ...
      <div className="flex-1 flex-col dash">
        ...
        <div className="flex flex-col dash1">
          {/* Table Header */}
          <div className="candi1 shadow grid grid-cols-5 text-lg gap-10 text-gray-600 font-semibold bg-gray-100 padd2">
            <p>Candidate Name</p>
            <p>Created On</p>
          ...
          <div className="mar1 bg-white p-6">
            {Array.isArray(filteredReports) && filteredReports.length > 0 ? (
              filteredReports.map((reports) => (
                <div
                  key={reports.id}
                  className="grid grid-cols-5 gap-6 py-4 items-center border-b border-gray-200 selectcan rounded-lg"
                >
